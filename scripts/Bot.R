...
ids = pull(read.csv(file.path(FILES_PATH, 'replied_to_ids.txt'), header = F, stringsAsFactors = F,numerals = "no.loss"))
...
write(ids, file.path(FILES_PATH, "replied_to_ids.txt"))
